...
class WeatherStation:
    ...
    def __init__(self, mqtt_server, mqtt_path, speed_pin, direction_error, direction_precision, send_sleep):
...
if __name__ == '__main__':
    ...
    try:
        w = WeatherStation(args.mqtt_server, args.mqtt_path, args.speed_pin, args.direction_error, args.direction_precision, args.send_sleep)
        if args.chart:
